...
def main() -> None:
    ...
    ingest.add_argument(
        ...
        type=int,
        help=(
            "Pin a specific revision for a live --entity fetch. Omitted, the "
            "served entity's own lastrevid is recorded, so the release stays "
            "reproducible. Refused with --fixture, which carries its own "
            "pinned revision."
        ),
    )
